            ...
            <div class="flex justify-center overflow-hidden shadow-sm sm:rounded-lg">
                <div class="flex-col w-2/5 m-8">
                    <div class="flex-col align-center bg-gray-800 dark:bg-white p-4">
                        ...
                        <img class="w-40 h-40 rounded-full bg-white border-2 dark:border-black mx-auto" src="https://www.svgrepo.com/show/396909/letter-s.svg" alt="Rounded avatar">
                        <div class="text-3xl">
                    ...
                    <div class="flex-col align-center bg-gray-800 dark:bg-white p-4 my-5">
                ...
                <div class="flex-col w-3/5 m-8">
                    <div class="flex-col align-center font-semibold text-3xl bg-gray-800 dark:bg-white p-4">
                        {{ __("Gigs list") }}
                        <x-primary-button>
                            {{ __("Add gig") }}
                        </x-primary-button>
